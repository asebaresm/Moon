...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/juego_v0.85

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/juego_v0.85: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/juego_v0.85 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/Maps.o: Maps.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Maps.o Maps.c
...
${OBJECTDIR}/Reglas_dialogo.o: Reglas_dialogo.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Reglas_dialogo.o Reglas_dialogo.c
...
${OBJECTDIR}/UtilCadena.o: UtilCadena.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/UtilCadena.o UtilCadena.c
...
${OBJECTDIR}/WorldXMLReader.o: WorldXMLReader.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/WorldXMLReader.o WorldXMLReader.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/juego_v0.85

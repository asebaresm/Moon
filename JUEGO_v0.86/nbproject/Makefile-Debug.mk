...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/juego_v0.85: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/juego_v0.85 ${OBJECTFILES} ${LDLIBSOPTIONS} `xml2-config --libs`
...
${OBJECTDIR}/Maps.o: Maps.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -Wall `xml2-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/Maps.o Maps.c

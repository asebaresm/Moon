...
/**
 *@name BOOL contains(Set *cj, Id id);
...
/**
 *@name STATUS remove_id(Set *cj, Id id);
...
/**
 *@name STATUS print_set_full(Set *cj);
 *@brief Imprime un conjunto con todas las carcterisiticas de los objetos

 *@param cj is a pointer to a valid set.

 *@return OK si todo esta bien, o ERROR en caso contrario.
 */
STATUS print_set_full(Set *cj);

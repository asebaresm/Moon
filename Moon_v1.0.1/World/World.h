...
/**
 * @name STATUS print_inventory_full (World *w);
 * @brief Printea el inventario con todas las caracteristicas de los ojetos
 * @param w
 * @return ERROR/OK
 */
...
/**
 * @name STATUS print_inventory (World *w);
 * @brief Printea el nombre de los ojetos del inventario
 * @param w
 * @return ERROR/OK
 */
STATUS print_inventory (World *w);
/**
 * @name STATUS world_open_door(World *w, Id link_id);
 * @brief Abre las puertas si el player cumple los requisitos
 * @param w
 * @param link_id
 * @return ERROR/OK
 */
...
/**
 * @name STATUS print_objs_space(World *w, Space *s );
 * @brief Printea el nombre de los objetos de un espacio
 * @param w
 * @param s
 * @return ERROR/OK
 */
...
/**
 * @name STATUS consume_obj_oxi(World *w, char *c);
 * @brief consume una botella de oxigeno
 * @param w
 * @param c
 * @return ERROR/OK
 */

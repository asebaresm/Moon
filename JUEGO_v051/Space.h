...
/**
 *@name: Set *space_get_set(Space *space);
 *@brief: devuelve el set de un espacio
 *@param: space
 *@return: set el puntero al set o null en caso de error
 */
Set *space_get_set(Space *space);


/**
 * @name const char * desc_space_graphical(Space *space);
 * @brief da la descripcion grafica de un espacio
 * @param space
 * @return devuelve la descripcion grafica de dicho espacio o NULL en caso de error
 */
const char * desc_space_graphical(Space *space);
